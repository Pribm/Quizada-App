...
class QuizzController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $quizz->fill([
            ...
            'withTime' => $request->withTime ? $request->withTime : 0,
    ...
    public function sendToken($token, $guest_user){
        ...
        if(!$quizz->invitation()->find($guest_user->id)){
            ...
            return response()->json(['success' => 'Parabéns, você acabou de convidar '.$guest_user->name.' para o seu quizz!'], 400);
        };
    ...
    public function storeScore(Request $request)
    {
        ...
        if($quizz->user_id !== $this->auth_user->id || $quizz->random_generated){
            ...
            if($score->save()){
                DB::table('quizz_invitation')->insert([
                    'user_id' => $this->auth_user->id,
                    'quizz_id' => $quizz->id,
                    'quizz_complete' => 1,
                    'created_at' => Carbon::now(),
    ...
    public function show($token)
    {
        ...
        $questions = Quizz::find($quizz->id)->questions;
    ...
    public function acceptQuizz($id)
    {
        ...
        if($quizz){
            if($this->auth_user->pendingQuizzInvitation()->update(['invitation_accepted' => true])){
                return $quizz;
            }
