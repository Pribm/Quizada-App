...
const createQuizzSchema = yup.object().shape({
    category: yup.number().min(1, 'Você precisa inserir uma categoria antes de criar um novo quizz').required("Você precisa inserir uma categoria antes de criar um novo quizz"),
