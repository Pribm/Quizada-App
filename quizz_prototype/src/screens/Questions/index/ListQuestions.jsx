import { Accordion, AccordionDetails, AccordionSummary, Button, Checkbox, Chip, FormControl, FormControlLabel, Grid, MenuItem, Paper, Select, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, TextField, Typography } from '@mui/material'
...
const ListQuestions = () => {
  ...
  const handleSelectAll = () => {
    ...
    if (!selectAll) {
      setQuestionList(questionList => questionList.concat(selectedQuestionsIds))
    } else {
      setQuestionList([])
    }
